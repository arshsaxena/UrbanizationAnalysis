...
var opticalArea2024 = opticalUrban2024
...
var opticalArea2018 = opticalUrban2018
	.multiply(ee.Image.pixelArea())
	.reduceRegion({
		reducer: ee.Reducer.sum(),
		geometry: studyArea,
...
Map.addLayer(
	...
	'Optical Expansion (2018-2024)',
	false,
);
Map.addLayer(
	radarExpansion,
	{ palette: ['white', 'yellow'] },
	'Radar Expansion (2018-2024)',
	false,
);
...
print(
	'2018 Urban Area (km²):',
	ee.Number(opticalArea2018.get('NDBI')).divide(1000000),
);
print(
	'2024 Urban Area (km²):',
	ee.Number(opticalArea2024.get('NDBI')).divide(1000000),
);
print(
	'Urban Growth (km²):',
	ee
		.Number(opticalArea2024.get('NDBI'))
		.subtract(ee.Number(opticalArea2018.get('NDBI')))
		.divide(1000000),
);
...
print(
	'2018 Urban Area (km²):',
	ee.Number(radarArea2018.get('VV')).divide(1000000),
);
print(
	'2024 Urban Area (km²):',
	ee.Number(radarArea2024.get('VV')).divide(1000000),
);
print(
	'Urban Growth (km²):',
	ee
		.Number(radarArea2024.get('VV'))
		.subtract(ee.Number(radarArea2018.get('VV')))
		.divide(1000000),
);
